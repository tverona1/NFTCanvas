...
export default function FAQ() {
    const tabs = [
        ...
        { id: "10", label: "Can I trade or sell my area?", description: (<p>Yes! Because the area you buy is an NFT, you can trade or sell it on any NFT market, like <a href="https://opensea.io/collection/nft-canvas-2" target="_blank" rel="noopener noreferrer">OpenSea</a>.</p>) },
