...
export default function FAQ() {
    const tabs = [
        ...
        { id: "10", label: "Can I trade or sell my area?", description: (<p>Yes! Because the area you buy is an NFT, you can trade or sell it on any NFT market, like <a href="https://opensea.io/" target="_blank" rel="noopener noreferrer">OpenSea</a>.</p>) },
        ...
        { id: "12", label: "Does this work on mobile?", description: (<p>Yes! To connect your wallet on mobile, open this site in the <a href="https://metamask.io/" target="_blank" rel="noopener noreferrer">MetaMask</a> app.</p>) },
        ...
        { id: "20", label: "Who are you?", description: (
            ...
            <p>Hi, my name is Tomer. I'm a professional software engineer by day and I enjoy creating projects like these as a hobby. Drop me a note anytime!</p>
                <a href="https://github.com/tverona1"  target="_blank" rel="noopener noreferrer" className="github social">
